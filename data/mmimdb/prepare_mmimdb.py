...
# dataset_h5 = h5py.File('/home/mghebriout/datasets/MM-IMDB/multimodal_imdb.hdf5', 'r')
dataset_h5 = h5py.File('<Path to multimodal_imdb.hdf5 file >', 'r')

dataset_len = dataset_h5['features'].shape[0]

# save_dir = "/home/mghebriout/datasets/MM-IMDB/Pre_processed/"
save_dir = "<Path to save the preprocessed data>"


# split_file = open('./data/mmimdb/mmimdb_split.json', 'r')
split_file = open('<Path to the mmimdb_split.json file>', 'r')
