...
from backbones.ofa.utils import MyNetwork, make_divisible, MyGlobalAvgPool2d
...
class MobileNetV3(MyNetwork):
    def __init__(
        self, first_conv, blocks, final_expand_layer, feature_mix_layer, classifier, resolution=224
    ):
