# Description: Visualize the architecture of the searched model https://github.com/Somedaywilldo/BM-NAS
...
def plot(genotype, filename, args, task=None):
    ...
    with g.subgraph() as nothing:
        ...
        with c.subgraph(name='cluster_video_features', node_attr={'shape': 'box'}) as ca:
            ...
            if task == 'memes_politics':
                input_nodes_A = ["Image_1", "Image_2", "Image_3", "Image_4", "Image_5", "Image_6", "Image_7"]
        ...
        with c.subgraph(name='cluster_skeleton_features', node_attr={'shape': 'box'}) as cb:
            ...
            if task == 'avmnist':
                input_nodes_B = ["Audio_1", "Audio_2", "Audio_3", "Audio_4"]
